        ...
        <div class="col-xl-6">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Form Update Asset Model</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form action="/assetModel/update/{{ $assetModel->assetModelId }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                @csrf
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control select2bs4" id="categoryId" name="categoryId">
                      @foreach ($categories as $category)
                          @if (old('categoryId', $assetModel->categoryId) == $category->categoryId)
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control select2bs4" id="manufactureId" name="manufactureId">
                      @foreach ($manufactures as $manufacture)
                          @if (old('manufactureId', $assetModel->manufactureId) == $manufacture->manufactureId)
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('assetModelNumber') is-invalid @enderror" id="assetModelNumber" name="assetModelNumber" value="{{ old('assetModelNumber', $assetModel->assetModelNumber) }}">
                  ...
                  <div class="form-group">
                    ...
                    <div class="mb-3">
                        <img src="{{ asset('storage/' .  $assetModel->assetModelImage ) }}" alt="{{ $assetModel->assetModelName }}" class="img-responsive" style="max-height: 300px; width: auto;">
                    </div>
