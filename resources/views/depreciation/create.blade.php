      ...
      <div class="row">
        <div class="col-xl-6">
            ...
            <div class="card">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="/depreciation/store" method="POST" enctype="multipart/form-data" class="form-horizontal">
                @csrf
                <div class="card-body">
                  <div class="form-group">
                    <label for="depreciationName" class="form-label">Depreciation Name <span class="text-danger">*</span></label>
                    <input type="text" class="form-control @error('depreciationName') is-invalid @enderror" id="depreciationName" name="depreciationName" value="{{ old('depreciationName') }}">
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control @error('depreciationUseful') is-invalid @enderror" id="depreciationUseful" name="depreciationUseful" value="{{ old('depreciationUseful') }}">
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control @error('depreciationResidual') is-invalid @enderror" id="depreciationResidual" name="depreciationResidual" value="{{ old('depreciationResidual') }}">
